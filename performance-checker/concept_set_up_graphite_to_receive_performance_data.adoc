...
* Si está ejecutando Graphite en un servidor implementado mediante una dirección IPv6, el valor para LINE_RECEIVER_INTERFACE en el archivo /opt/Graphite/conf/carbon.conf' debe cambiarse de "'0.0.0.0'" a "':'""" (`*LINE_RECEIVER_INTERFACE = ::*`)

...
Asimismo, existe un límite en cuanto al número de nodos que puede supervisar una única instancia de Unified Manager antes de instalar una segunda instancia de Unified Manager. Para obtener más información, consulte link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["Guía de prácticas recomendadas de Unified Manager"^]

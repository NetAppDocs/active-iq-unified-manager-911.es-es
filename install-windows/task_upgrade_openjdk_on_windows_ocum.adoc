...
Puede actualizar versiones de OpenJDK dentro de las familias de versiones. Por ejemplo, puede actualizar de OpenJDK 11.0.12 a OpenJDK 11.0.13, pero no puede actualizar directamente de OpenJDK 11 a OpenJDK 12.
...
. Copie los directorios y archivos del resultado `jdk` directorio (por ejemplo, `jdk-11.0.13` A la ubicación donde está instalado Java. Ejemplo: `C:\Program Files\NetApp\JDK\`
